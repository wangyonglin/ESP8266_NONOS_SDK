...
//--------------------------------------------------------------------------------------------------------------------------------------
#define MQTT_HOST			"a1KXAMVFitC.iot-as-mqtt.cn-shanghai.aliyuncs.com" 		// MQTT服务端域名/IP地址	// the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT       	1883    										// 网络连接端口号			// the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID   	"ESP82660001|securemode=3,signmethod=hmacsha1,timestamp=789|"	// 官方例程中是"Device_ID"		// 客户端标识符				// the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER        	"ESP82660001&a1KXAMVFitC" 			// MQTT用户名				// your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS        	"d5399c0ebd1f71e0de49c9294233439ed39676b6" 	// MQTT密码					// you MQTT login password, same as above
#define MQTT_TOPIC			"/a1KXAMVFitC/ESP82660001/user/router"	//MQTT 主提

#define STA_SSID 			"vivo Y85"    	// WIFI名称					// your AP/router SSID to config your device networking
#define STA_PASS 			"11112222" 	// WIFI密码					// your AP/router password
